...
public class UvWithBloomFilter {
    ...
    // 自定义触发器
    public static class MyTrigger extends Trigger<ItemBean, TimeWindow> {
        @Override
    ...
    // 实现自定义的处理函数 位图放在redis中
    public static class UvCountResultWithBloomFliter extends ProcessAllWindowFunction<ItemBean, PageViewCount, TimeWindow> {
        // 定义jedis连接和布隆过滤器
        Jedis jedis;
